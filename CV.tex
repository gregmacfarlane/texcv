...
\item \textbf{Macfarlane, G.S.}, Turley Voulgaris, C., \& Tapia, T. (2021). If you build it who will come? Equity analysis of park system changes during COVID-19 using passive origin-destination data. Under second-round review at \textit{Journal of Transportation and Land Use}.
...
\vspace{0.2cm}
\begin{enumerate}[left=0pt, itemsep = 10pt, label=UG\arabic*]
