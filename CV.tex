...
\begin{myenum}[14]
  ...
  \item Daines, T.J.$^\dagger$, Schultz, G.G., \textbf{Macfarlane, G.S.}, \& Ward, C.$^*$ (2022), Evaluating real time ramp meter queue length estimation. Under initial review at \textit{Future Transportation}.

  \item Turley Voulgaris, C., \textbf{Macfarlane, G.S.}, Kaylor, J., Su, T., Bauranov, A. (2022). Whose emissions are these anyway? Estimating vehicle miles traveled to account for site-level climate impacts. Under initial review at \textit{Transport Policy}.
  ...
  \item Wang, B.$^\dagger$, Schultz, G.G., \textbf{Macfarlane, G.S.}, \& McCuen, S.$^*$ (2022). Evaluating signal systems using automated traffic signal performance measures. \textit{Future Transportation}. 2(3):  659-674. \url{https://doi.org/10.3390/futuretransp2030036}.
