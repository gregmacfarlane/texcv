...
\begin{myenum}[28]
  ...
  \item Turley Voulgaris, C., \textbf{Macfarlane, G.S.}, Kaylor, J. (2024). Relationships between mode choice and independence for the journey to school.
  Under review at \textit{Journal of Transportation and Health}.
...
\begin{description}
  ...
  rail, and urban transportation systems and infrastructure. CiteScore: 3.8; 153/379 in civil engineering. Publisher: ASCE.
  ...
  interaction of transport and land use. CiteScore: 3.4; 75/279 in urban studies.
  ...
  CiteScore: 3.2; 181/379 in civil engineering. Publisher: Sage.
...
\begin{tabular}{cccc}
  ...
  Spring 2023 (Study Abroad) & 20 & 3.9 - 4.9 (4.2) & 3.32\\
  \bottomrule
\end{tabular}
...
\item Inspires us to be not only better students but better engineers. Helps us
to look for ways to not just be a part of the system, but to improve the system.
