...
First author or first faculty author on 7 of 18 total journal articles.
...
\begin{myenum}[18]
  ...
  Under initial review at \textit{Transportation Research Part A: Policy and Practice}.
...
resulted from my doctoral work, and items 6 through 9 represent work completed since joining the faculty at BYU.\fi
\vspace{.3cm}
\begin{myenum}[9]
...
items 5 through 10 from my work as a consultant, and items 11 through 25 represent work
completed during my time at BYU.\fi
\vspace{0.3cm}
\begin{myenum}[25]
\item Guan, H.Z., Van Hentenryck, P., Erhardt, G.D., \textbf{Macfarlane, G.S.}, \& Watkins, K.E. (2023). Lessons from the design of on-demand multimodal transit systems in two cities. In \textit{Innovations in Transportation Analysis and Planning Conference}. Lectern presentation. Indianapolis, Indiana.
...
Students mentored as graduate committee chair (9 total, 4 current):
\vspace{0.3cm}
\begin{myenum}[9]
  ...
  \item Natalie Gray. MS scheduled April 2023.
...
Students mentored as graduate committee member (15 total, 5 current, 2 non-BYU):
\vspace{0.3cm}
\begin{myenum}[15]
  \item Joel Hyer. MS scheduled December 2023.
  \item Benjamin Meek. MS scheduled April 2023.
