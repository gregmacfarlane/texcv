...
\begin{myenum}[26]
  ...
  \item \textbf{Macfarlane, G.S.} \& Gibbons, N.$^\dagger$ (2024). 
  ...
  \item Turley Voulgaris, C., \textbf{Macfarlane, G.S.}, Fjendbo-Jensen, A. (2024). Relationships between mode choice and independence for the journey to school.
  Under review at \textit{Journal of Transport \& Health}.
...
Students mentored as graduate committee member (22 total, 5 current, 3 non-BYU, 3 Ph.D.):
\vspace{0.3cm}
\begin{myenum}[22]
  \ifdetail {\color{NavyBlue} \fi
