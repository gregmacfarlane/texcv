...
First author or first faculty author on 7 of 15 total journal articles.
...
\begin{myenum}[15]
  ...
  \item Turley Voulgaris, C., \textbf{Macfarlane, G.S.}, Kaylor, J., Su, T.,
  Bauranov, A. (2022). Whose emissions are these anyway? Estimating vehicle
  miles traveled to account for site-level climate impacts. Under initial review
  at \textit{Transport Policy}.
  ...
  \item\textbf{Macfarlane, G.S.}, Hunter, C.$^*$, Martinez, A.$^*$, \& Smith,
  E.$^*$  (2021). Rider Perceptions of an On-Demand Microtransit Service in Salt
  Lake County, Utah \textit{ Smart Cities} 4(2): 717-727.
...
items 5 through 10 from my work as a consultant, and items 11 through 23 represent work
...
\begin{myenum}[9]
  ...
  \item Natalie Gray. MS scheduled April 2022.
...
Students mentored as graduate committee member (14 total, 4 current, 2 non-BYU):
\vspace{0.3cm}
\begin{myenum}[14]
  \item Joel Hyer. MS scheduled December 2023.
  \item Mylan Cook. Ph.D.\ in Physics proposed May 2022.
  \item Tomas Barriga. MS scheduled April 2022.
...
Students mentored on funded research projects (22 total):
\vspace{0.2cm}
\begin{myenum}[22]
